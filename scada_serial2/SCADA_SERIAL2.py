...
data_dict_1 = {
  'Tensión L1-N': {'offset': 1, 'reg': 2, 'color': '#9103A6', 'label': 'Tensión L1-N', 'unit': ' [V]', 'graphic':0, 'factor':1, 'QLabel': 'lineEdit_3'},
...
class LIVE_PLOT_APP(QtWidgets.QMainWindow):
    ...
    def update_plot(self, data, widget_id):
        ...
        for key, value in data.items():
            ...
            # Actualizar el QLabel correspondiente si existe
            if 'QLabel' in globals()[f'data_dict_{widget_id+1}'][key]:
                qlabel_name = globals()[f'data_dict_{widget_id+1}'][key]['QLabel']
