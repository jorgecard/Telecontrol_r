...
ip = '192.168.222.12'  # IP batería de litio
...
client.write_register(address = 108, value = unsigned_value, unit=1)  # Escribir en el registro 39

# client.write_register(38, write_values, unit=1)  # Escribir en el registro 39
