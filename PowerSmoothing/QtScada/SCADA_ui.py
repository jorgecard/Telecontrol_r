...
"}")
        ...
        self.pushButton_set_control = QPushButton(self.control_selected)
        self.pushButton_set_control.setObjectName(u"pushButton_set_control")
        self.pushButton_set_control.setGeometry(QRect(20, 110, 101, 40))
        self.pushButton_set_control.setMinimumSize(QSize(0, 40))
        self.pushButton_set_control.setStyleSheet(u"font: 10pt \"Segoe UI\";\n"
