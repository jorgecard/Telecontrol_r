...
# Variables
ips= ['192.168.222.180', '192.168.222.136'] 
...
class PyShine_LIVE_PLOT_APP(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.channels = [1]              # Establece los canales de audio ([1] mono)
        self.interval = 30               # Establece el intervalo de actualización del gráfico en milisegundos.
        
        # device_info =  sd.query_devices(self.device, 'input')
        # self.samplerate = device_info['default_samplerate']

        self.samplerate = 44100         # tasa de muestreo a 44100 Hz (estándar)
